...
class laporan_ap_xls_parser(report_sxw.rml_parse):
    
    def __init__(self, cr, uid, name, context):
        super(laporan_ap_xls_parser, self).__init__(cr, uid, name,
                                                         context=context)
        self.context = context


class laporan_ap_xls(report_xls):
    
    def __init__(self, name, table, rml=False, parser=False, header=True,
                 store=False):
        super(laporan_ap_xls, self).__init__(
...
laporan_ap_xls('report.laporan.ap.xls', 'account.invoice', parser=laporan_ap_xls_parser)
