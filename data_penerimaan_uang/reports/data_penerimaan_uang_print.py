...
class data_penerimaan_uang_xls_parser(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context):
        super(data_penerimaan_uang_xls_parser, self).__init__(cr, uid, name,
                                                         context=context)
...
class data_penerimaan_uang_xls(report_xls):
    ...
    def generate_xls_report(self, _p, _xs, data, objects, wb):
        ...
        ws = wb.add_sheet("Data Penerimaan Uang")
        ...
        ws.write_merge(0,0,0,4,"DAFTAR PENERIMAAN UANG LAIN-LAIN",title_style_center)
        ...
        headers = ["Tanggal","Keterangan","Pembayaran","Bank","Statement"]
        ...
        max_len = [0,0,0,0,0]
        for rec in objects:
            ws.write(row,0,rec.date,normal_style)
